...
- **Validación** (2026-07-17, lanzando desde el botón de la app): FEZ (FNA), Terraria (XNA),
  ...
  fluida confirmada por el usuario. La limpieza D3DMetal quedó además blindada para conservar el
  `D3D12Core.dll` oficial entre ejecuciones. Su contrato de carga gráfica dinámica, la regresión de
  segundo arranque y sus pruebas de caracterización se documentan en
